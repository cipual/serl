...
python /home/star/serl/examples/async_peg_insert_drq/async_drq_randomized.py "$@" \
    ...
    --exp_name=serl_dev_drq_rlpd10demos_peg_insert_random_resnet_005 \
    --seed 0 \
    --random_steps 1000 \
    --training_starts 200 \
    ...
    --demo_path /home/star/serl/examples/async_peg_insert_drq/peg_insert_40_demos_insert_random_long_z5.pkl \
